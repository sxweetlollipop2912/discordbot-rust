...
#[check]
#[name = "user_in_voice_with_bot"]
pub async fn user_in_voice_with_bot_check(
    ctx: &Context,
    msg: &Message,
    _: &mut Args,
    _: &CommandOptions,
    ...
    let handler_lock = match manager.get(guild_id) {
        ...
        None => {
            return Err(Reason::User("Checking InVoiceWithBot failed, bot not in voice channel.".to_string()));
        },
    };
